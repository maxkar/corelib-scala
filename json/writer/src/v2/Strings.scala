...
object Strings {
  ...
  def writeStringBoundary[M[_], S: Writer.In[M]](stream: S): M[Unit] =
   ...
   */
  def writeStringContent[M[_]: Monad, S: Writer.In[M]](
        data: CharSequence,
        stream: S,
      ): M[Unit] =
   ...
   */
  def writeString[M[_]: Monad, S: Writer.In[M]](
        data: CharSequence,
        stream: S,
      ): M[Unit] =
    for
   ...
   */
  private def writeStringRest[M[_]: Monad, S: Writer.In[M]](
        data: CharSequence,
        start: Int,
        stream: S
      ): M[Unit] = {
   ...
   */
  private def writeStringWithSpecial[M[_]: Monad, S: Writer.In[M]](
        data: CharSequence,
        start: Int,
        regularEnd: Int,
        special: String,
